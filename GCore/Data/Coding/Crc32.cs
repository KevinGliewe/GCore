...
// From http://rosettacode.org/wiki/CRC-32#C.23
...
namespace GCore.Data.Coding {
    ...
    /// </summary>
    public class Crc32 {
        public static Crc32 Instance { get; private set; } = new Crc32();

        public static UInt32 Hash(String s) {
            return Instance.Get(Encoding.UTF8.GetBytes(s));
        }
